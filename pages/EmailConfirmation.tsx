...
export const EmailConfirmation: React.FC<EmailConfirmationProps> = ({ onNavigateToLogin }) => {
    ...
    return (
        <div className={`min-h-screen bg-gradient-to-br ${getStatusColor()} flex items-center justify-center p-4 relative overflow-hidden`}>
            ...
            <div className="absolute bottom-[-10%] right-[-10%] w-96 h-96 bg-white rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-blob animation-delay-2000"></div>
            ...
            <div className="max-w-md w-full bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden z-10 border border-white/50">
                <div className="bg-white/50 pt-12 pb-8 px-8 text-center border-b border-slate-100">
                   ...
                   `;
                    ...
                    <h2 className="text-2xl font-bold text-slate-800">Confirmação de Email</h2>
                    ...
                    {status === 'success' && (
                        <div className="text-center mb-6">
                            <p className="text-sm text-slate-500">
                                Redirecionando em <span className="font-bold text-brand-600">{countdown}</span> segundo{countdown !== 1 ? 's' : ''}...
                            </p>
                        </div>
                    )}
