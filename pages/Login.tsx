...
export const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-600 via-brand-500 to-accent-DEFAULT flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-96 h-96 bg-accent-300 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-blob animation-delay-2000"></div>

      <div className="max-w-md w-full bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden z-10 border border-white/50">
        <div className="bg-white/50 pt-12 pb-8 px-8 text-center border-b border-slate-100">
          {/* Logo Placement */}
        ...
        <div className="p-8 pt-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-3 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all bg-slate-50 focus:bg-white text-slate-900 outline-none"
            ...
            {success && (
              <div className="text-sm text-green-700 bg-green-50 p-3 rounded-xl border border-green-200 flex items-center">
                <span className="mr-2">✓</span> {success}
              </div>
            )}

            {error && (
              <div className="text-sm text-red-600 bg-red-50 p-3 rounded-xl border border-red-100 flex items-center animate-shake">
        ...
        <div className="px-8 py-4 bg-slate-50/50 border-t border-slate-100 text-center">
          <p className="text-xs text-slate-400 font-medium">MC Sistemas &copy; {new Date().getFullYear()} • Todos os direitos reservados</p>
        </div>
      </div>
    </div>
  );
